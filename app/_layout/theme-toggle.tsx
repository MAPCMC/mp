    ...
    <div className="relative flex items-stretch px-10 md:px-12">
      {mounted && (
        ...
        >
          ...
          <CarouselPrevious className="-left-8 h-10 rounded-r-none dark:rounded-l-md basic:md:h-full basic:md:border-none basic:md:border-inherit" />
          <CarouselNext className="-right-8 h-10 rounded-l-none dark:rounded-r-md basic:md:h-full basic:md:border-none basic:md:border-inherit" />
        </Carousel>
      )}
    </div>
  );
